...
security import ./signing/ios/dist.p12 -k ~/Library/Keychains/ios-build.keychain -P $IOS_BUILDCERT_PASS -T /usr/bin/codesign
...
cp "./signing/ios/$PROFILE_NAME.mobileprovision" ~/Library/MobileDevice/Provisioning\ Profiles/
